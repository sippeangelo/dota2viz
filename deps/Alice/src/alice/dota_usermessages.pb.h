...
const EDotaUserMessages EDotaUserMessages_MAX = DOTA_UM_GlyphAlert;
...
const DOTA_CHAT_MESSAGE DOTA_CHAT_MESSAGE_MAX = CHAT_MESSAGE_VOICE_TEXT_BANNED_OVERFLOW;
...
inline void CDOTAUserMsg_ShowSurvey::clear_teammate_name() {
  if (teammate_name_ != &::google::protobuf::internal::kEmptyString) {
...
inline ::std::string* CDOTAUserMsg_ShowSurvey::release_teammate_name() {
  ...
  if (teammate_name_ == &::google::protobuf::internal::kEmptyString) {
    ...
    teammate_name_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
    return temp;
  }
}
